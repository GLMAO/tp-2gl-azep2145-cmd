...
public class CoursBuilder {
    ...
    private boolean estOptionnel = false; // valeur par défaut
    private String niveau = "Licence"; // valeur par défaut
    private boolean necessiteProjecteur = false; // valeur par défaut
